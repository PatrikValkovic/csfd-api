...
describe('Parsing of sites about film', function () {
  ...
  it('Should parse Pulp Fiction film', async function () {
    ...
    fs.writeFileSync(`${__dirname}/../../vzor.txt`, JSON.stringify(vzor))
    fs.writeFileSync(`${__dirname}/../../parsed.txt`, JSON.stringify(parsed))

    assert.deepStrictEqual(parsed, vzor)
  })
